...
const mockUser = { email: 'test@test.com', name: 'Test User' } as any;
describe('userSlice reducer', () => {
  ...
  it('should handle registerUser.rejected', () => {
    const state = reducer(
      ...
      { type: registerUser.rejected.type, payload: 'Ошибка при регистрации' }
    );
    expect(state).toEqual({
      ...initialState,
      isLoading: false,
  ...
  it('should handle loginUser.rejected', () => {
    const state = reducer(
      ...
      { type: loginUser.rejected.type, payload: 'Ошибка при входе' }
    );
    expect(state).toEqual({
      ...initialState,
      isLoading: false,
  ...
  it('should handle updateUser.fulfilled', () => {
    const updatedUser = { email: 'test@test.com', name: 'Updated User' } as any;
    const state = reducer(initialState, {
  ...
  it('should handle logoutUser.fulfilled', () => {
    ...
    expect(state).toEqual({ ...initialState, user: null, isAuthChecked: true });
  });
